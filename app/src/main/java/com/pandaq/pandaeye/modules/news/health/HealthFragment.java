...
public class HealthFragment extends BaseFragment implements NewsContract.View, SwipeRefreshLayout.OnRefreshListener, BaseRecyclerAdapter.OnItemClickListener {
    ...
    public void onItemClick(int position, BaseItem data, View view) {
        ...
        Intent intent = new Intent(HealthFragment.this.getActivity(), NewsDetailActivity.class);
