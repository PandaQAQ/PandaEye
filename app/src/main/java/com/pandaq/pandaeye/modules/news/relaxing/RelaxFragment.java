...
public class RelaxFragment extends BaseFragment implements NewsContract.View, SwipeRefreshLayout.OnRefreshListener, BaseRecyclerAdapter.OnItemClickListener {
    ...
    public void onItemClick(int position, BaseItem data, View view) {
        ...
        Intent intent = new Intent(RelaxFragment.this.getActivity(), NewsDetailActivity.class);
