...
public class SportNewsFragment extends BaseFragment implements NewsContract.View, SwipeRefreshLayout.OnRefreshListener, BaseRecyclerAdapter.OnItemClickListener {
    ...
    TextView mEmptyMsg;
    private SportPresenter mPresenter = new SportPresenter(this);
    ...
    public void onItemClick(int position, BaseItem data, View view) {
        ...
        Intent intent = new Intent(SportNewsFragment.this.getActivity(), NewsDetailActivity.class);
