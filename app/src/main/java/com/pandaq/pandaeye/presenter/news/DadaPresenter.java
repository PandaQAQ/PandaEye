...
public class DadaPresenter extends BasePresenter {

    private INewsListFrag mNewsListFrag;
    private int currentIndex;

    public DadaPresenter(INewsListFrag newsListFrag) {
    ...
    public void refreshNews() {
        ...
        ApiManager.getInstence().getTopNewsServie()
                ...
                .map(new Function<DadaNewsList, ArrayList<NewsBean>>() {
                    @Override
                    public ArrayList<NewsBean> apply(DadaNewsList dadaNewsList) {
