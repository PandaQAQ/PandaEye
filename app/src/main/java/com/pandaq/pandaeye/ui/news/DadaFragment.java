...
import com.pandaq.pandaeye.presenter.news.DadaPresenter;
...
public class DadaFragment extends BaseFragment implements INewsListFrag, SwipeRefreshLayout.OnRefreshListener, BaseRecyclerAdapter.OnItemClickListener {
    ...
    TextView mEmptyMsg;
    private DadaPresenter mPresenter = new DadaPresenter(this);
