...
import com.pandaq.pandaeye.presenter.news.MilitaryPresenter;
...
public class MilitaryFragment extends BaseFragment implements INewsListFrag, SwipeRefreshLayout.OnRefreshListener, BaseRecyclerAdapter.OnItemClickListener {
    ...
    public void onItemClick(int position, BaseItem data, View view) {
        ...
        Intent intent = new Intent(MilitaryFragment.this.getActivity(), TopNewsInfoActivity.class);
