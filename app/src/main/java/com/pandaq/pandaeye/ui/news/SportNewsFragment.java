...
import com.pandaq.pandaeye.presenter.news.SportPresenter;
...
public class SportNewsFragment extends BaseFragment implements INewsListFrag, SwipeRefreshLayout.OnRefreshListener, BaseRecyclerAdapter.OnItemClickListener {
