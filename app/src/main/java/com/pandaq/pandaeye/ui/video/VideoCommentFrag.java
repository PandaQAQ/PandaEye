...
//        subscription = RxBus
//                .getDefault()
//                .toObservableWithCode(RxConstants.LOAD_DATA_COMMENT_RESULT_OK, CommentBean.class)
...
//                    }
//                });
//        //接收加载完成的 Rxbus以及当前加载的 id
//        msgSubscription = RxBus
//                .getDefault()
//                .toObservableWithCode(RxConstants.LOAD_DATA_COMMENT_RESULT_THROWABLE, MsgSend.class)
//                .observeOn(AndroidSchedulers.mainThread())
//                .subscribe(new Action1<MsgSend>() {
//                    @Override
//                    public void call(MsgSend msg) {
//                        if (msg.getMsgCode()==)) {
//                            noMore();
//                            Message message = new Message();
//                        } else if (){
//                            loadId = msg.getMessage();
//                        }
//                    }
//                });
//    }
