package com.pandaq.pandaqlib.bottomnavigation;
...
import com.pandaq.pandaqlib.bottomnavigation.behaviour.BottomNavBarFabBehaviour;
import com.pandaq.pandaqlib.bottomnavigation.behaviour.BottomVerticalScrollBehavior;
import com.pandaq.pandaqlib.bottomnavigation.utils.Utils;
...
//    }
     ...
     *
     * @param needKeep keepBackgroundColor after Ripple finished
     * @return this, to allow builder pattern
     */
    public BottomNavigationBar setKeepRipple(boolean needKeep, int color) {
        if (!needKeep) {
            keepRipple = false;
            mRippleColor = color;
        }
    ...
    public BottomNavigationBar resetRipple() {
        keepRipple = true;
        mRippleColor = -1;
        return this;
    }
    ...
    public BottomNavigationBar setAnimationDuration(int animationDuration) {
        ...
        this.mRippleAnimationDuration = (int) (animationDuration * 3.0);
        return this;
    }
            ...
            if (mBackgroundStyle == BACKGROUND_STYLE_STATIC) {
                ...
                if (firstTab) {
                    ...
                    mBackgroundOverlay.post(new Runnable() {
                        ...
                        public void run() {
                            if (keepRipple) {
                                mRippleColor = clickedView.getActiveColor();
                            }
                            BottomNavigationHelper.setBackgroundWithRipple(clickedView, mContainer, mBackgroundOverlay, mRippleColor, mRippleAnimationDuration, keepRipple);
                        }
                    });
                }
            }
