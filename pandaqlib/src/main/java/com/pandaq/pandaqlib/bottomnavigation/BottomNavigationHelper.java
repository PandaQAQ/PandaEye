...
class BottomNavigationHelper {
     ...
     * @param rippleColor       the new color i.e ripple color
     * @param animationDuration duration for which animation runs
     * @param keepBackground    keep backgroundColor or not after Ripple finished
     */
    public static void setBackgroundWithRipple(View clickedView, final View backgroundView,
                                               final View bgOverlay, final int rippleColor, int animationDuration, final boolean keepBackground) {
        ...
        circularReveal.addListener(new AnimatorListenerAdapter() {
            ...
            private void onCancel() {
                if (keepBackground) {
                    backgroundView.setBackgroundColor(rippleColor);
                }
